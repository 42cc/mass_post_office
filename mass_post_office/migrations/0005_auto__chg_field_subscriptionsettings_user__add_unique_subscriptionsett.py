...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mass_post_office_subscriptionsettings', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SubscriptionSettings.user'
        db.alter_column(u'mass_post_office_subscriptionsettings', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
